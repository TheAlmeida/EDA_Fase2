...
void contactus()
{
    ...
    printf("| Pra�a do Com�rcio   | R. da Bolsa         | Tv. Inglesinhos      |\n");
    printf("| 4700-370 Braga      | n�19,4050-253 Porto | n�46A,1200-079 Lisboa|\n");
    printf("|                     |                     |                      |\n");
    printf("| 1 - Ver localiza��o | 2 - Ver localiza��o | 3 - Ver localiza��o  |\n");
    printf("|------------------------------------------------------------------|\n");
    printf("|                                                    0 - RETROCEDER|\n");
    printf("|------------------------------------------------------------------|\n");
}
